...
model {
    ...
    target += beta_w * ((1 / beta) * exp(bernoulli_logit_glm_lpmf(y_synth | X_synth, alpha, coefs)) ^ (beta) - (1 / (beta + 1)) * (exp(bernoulli_logit_glm_lpmf(y_synth | X_synth, alpha, coefs)) ^ (beta + 1) + (1 - exp(bernoulli_logit_glm_lpmf(y_synth | X_synth, alpha, coefs))) ^ (beta + 1)));
